...
Foam::scalar
Foam::light::extinctionModel::k(const label bandI) const
{
    return 0.0;
}
...
Foam::scalar
Foam::light::extinctionModel::a(const label bandI) const
{
    return 0.0;
}
...
Foam::scalar
Foam::light::extinctionModel::s(const label bandI) const
{
    return 0.0;
}
